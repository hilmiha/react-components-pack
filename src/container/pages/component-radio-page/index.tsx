...
const ComponentRadioPage = () =>{
    ...
    useEffect(()=>{
        setSidebarMenuListSelected('radio')
    },[])
    ...
    return(
        <DetailTemplate 
            title="Radio" 
            subTitle="Radioes allow users to select multiple items from a list of individual items, or to mark one individual item as selected."
            tabList={[
