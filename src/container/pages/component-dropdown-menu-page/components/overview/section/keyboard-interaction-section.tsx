                    ...
                    tableData={[
                        {
                            ...
                            desc:<><p>When focused on the dropdown button will toggle the dropdown menu, opening it if closed and closing it if open.</p><p>When focused on the dropdown menu item, will fires the function on <span className="font-code">onClickItem</span> prop.</p></>
                        },
                        {
                            id:'enter',
                        ...
                        },
                        {
                            ...
                            desc:<><p>When focused on the dropdown button or dropdown menu item, closing dropdon menu if it openned.</p></>
                        },
                        {
                            id:'tab',
